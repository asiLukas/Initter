...
from .views import register_view, profile_view, base_profile_view, register_update_view, profile_update_view, \
...
urlpatterns = [
    ...
    path('search/', base_profile_view, name='base_profile'),
